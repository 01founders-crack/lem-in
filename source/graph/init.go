...
func (a *graph) SetAntsFromLine(line string) error {
...
func (a *graph) SetRoomFromLine(line string) (*room, error) {
...
func (a *graph) SetMainRooms(line string, startOrEnd bool) error {
...
func (a *graph) SetPathsFromLine(line string) error {
	splited := strings.Split(line, "-")
